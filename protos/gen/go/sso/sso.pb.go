...
func (x *IsAdmnRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmnRequest) ProtoMessage() {}

func (x *IsAdmnRequest) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmnRequest.ProtoReflect.Descriptor instead.
func (*IsAdmnRequest) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{4}
}

func (x *IsAdmnRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *IsAdmnResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmnResponse) ProtoMessage() {}

func (x *IsAdmnResponse) ProtoReflect() protoreflect.Message {
	mi := &file_sso_sso_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmnResponse.ProtoReflect.Descriptor instead.
func (*IsAdmnResponse) Descriptor() ([]byte, []int) {
	return file_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdmnResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\rIsAdmnRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"+\n" +
	"\x0eIsAdmnResponse\x12\x19\n" +
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\xa8\x01\n" +
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x123\n" +
	"\x06IsAdmn\x12\x13.auth.IsAdmnRequest\x1a\x14.auth.IsAdmnResponseB1Z/github.com/Garmon123/protos/gen/go/sso/v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*IsAdmnRequest)(nil),    // 4: auth.IsAdmnRequest
	(*IsAdmnResponse)(nil),   // 5: auth.IsAdmnResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmn:input_type -> auth.IsAdmnRequest
	1, // 3: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.IsAdmn:output_type -> auth.IsAdmnResponse
